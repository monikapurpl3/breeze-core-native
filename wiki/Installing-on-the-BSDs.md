...
```sh
pkg_add https://aspic.salataputarica.hr.eu.org/netbsd/All/breeze-core-4.1.1.tgz
```
...
doas pkg_add https://aspic.salataputarica.hr.eu.org/openbsd/7.9/packages/amd64/breeze-core-4.1.1.tgz
