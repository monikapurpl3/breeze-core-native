...
|---|---|---|---|
| `4.1.1` | `scratch` | **1.6 MB** | everyone |
| `4.1.1-debug` | `busybox:musl` | 2.5 MB | working out why something is wrong |
...
docker run --rm -it --network host \
  ...
  ghcr.io/monikapurpl3/breeze-core-native:4.1.1 pair
...
docker run -d --name breeze-core --restart unless-stopped \
  ...
  ghcr.io/monikapurpl3/breeze-core-native:4.1.1
```
